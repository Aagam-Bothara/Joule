...
\textsc{consult} asks the next rung up and \textsc{handoff} moves execution to it; a reasoning breakdown (repeated unparseable output, or a give-up before any step succeeded) skips to the top rung, since the middle rung would only burn a hop.
