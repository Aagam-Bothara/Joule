...
export const MODEL_PRICING: Record<string, { inputPerMillion: number; outputPerMillion: number }> = {
  ...
  // 2026 lineup (OpenRouter list prices, September 2026)
  'qwen/qwen3.5-9b': { inputPerMillion: 0.10, outputPerMillion: 0.15 },
  'qwen/qwen3.7-flash': { inputPerMillion: 0.03, outputPerMillion: 0.13 },
  'google/gemma-4-26b-a4b-it': { inputPerMillion: 0.07, outputPerMillion: 0.34 },
  'nvidia/nemotron-3-nano-30b-a3b': { inputPerMillion: 0.05, outputPerMillion: 0.20 },
  'deepseek/deepseek-v4-flash': { inputPerMillion: 0.088, outputPerMillion: 0.176 },
  'openai/gpt-5.6-luna': { inputPerMillion: 0.20, outputPerMillion: 1.20 },
  'openai/gpt-5.4-mini': { inputPerMillion: 0.75, outputPerMillion: 4.50 },
  'google/gemini-3.8-flash': { inputPerMillion: 0.75, outputPerMillion: 3.75 },
  'anthropic/claude-sonnet-5': { inputPerMillion: 2.00, outputPerMillion: 10.00 },
  'openai/gpt-5.6-terra': { inputPerMillion: 2.00, outputPerMillion: 12.00 },
  'anthropic/claude-opus-5': { inputPerMillion: 5.00, outputPerMillion: 25.00 },
  'openai/gpt-5.5': { inputPerMillion: 5.00, outputPerMillion: 30.00 },
  // Ollama (local = free)
